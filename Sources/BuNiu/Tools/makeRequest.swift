...
extension Utility {
	...
	/// - body: The JSON formatted string to sent to the server
	/// Response:
	/// "data" - [String:Any]
	static func makeRequest(_ method: HTTPMethod, _ url: String, body: String = "", encoding: String = "JSON", bearerToken: String = "" ) -> ([String:Any]) {
